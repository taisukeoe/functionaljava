...
public final class Strings {
   ...
   */
  public static final F<String, Boolean> isNotNullOrEmpty =
    a -> a != null && a.length() > 0;
   ...
   */
  public static final F<String, F<String, Boolean>> contains = curry(
   ...
   */
  public static final F<String, F<String, Boolean>> matches = curry(
    (s1, s2) -> s2.matches(s1)
  );
