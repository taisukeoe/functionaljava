...
public final class Semigroup<A> {
   ...
   */
  public static final Semigroup<Integer> intAdditionSemigroup = semigroup(
    (i1, i2) -> i1 + i2
  );
   ...
   */
  public static final Semigroup<Double> doubleAdditionSemigroup = semigroup(
    (d1, d2) -> d1 + d2
  );
   ...
   */
  public static final Semigroup<Integer> intMultiplicationSemigroup = semigroup(
    (i1, i2) -> i1 * i2
  );
   ...
   */
  public static final Semigroup<Double> doubleMultiplicationSemigroup = semigroup(
    (d1, d2) -> d1 * d2
  );
